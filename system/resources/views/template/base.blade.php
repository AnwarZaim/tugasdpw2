        ...
        <div class="header-bottom">
            <div class="wrap">
                ...
                <ul class="megamenu skyblue">
                    <li class="active grid"><a class="color4" href="{{ url('home') }}">Home</a><span> </span>
                    </li>
                    <li class="active grid"><a class="color4" href="{{ url('home') }}">Produk</a><span> </span>
                    </li>
    ...
    <div class="img-slider">
        <div class="wrap">
            <ul id="jquery-demo">
                <li>
                    <a href="#slide1">
                        <img src="{{ url('/public') }}/images/slide-1.jpg" alt="" />
                    </a>
                ...
                <li>
                    <a href="#slide2">
                        <img src="{{ url('/public') }}/images/slide-4.jpg" alt="" />
                    </a>
                    <div class="slider-detils">
                        <h3>MENS FOOT BALL <label>BOOTS</label></h3>
                        <span>Stay true to your team all day, every day, game day.</span>
